...
prompt = "A photo of 1pizza pizza_slice"
proj_name = "test"
proj_path = "./imagenet_sd_pizza_rq1/" + proj_name + "_"
...
for n in range(imgs_to_samp):
    ...
    with torch.inference_mode():
         ...
         #init_img = pipe(prompt,num_inference_steps = num_inference_steps, guidance_scale = 7.5, generator = generator)["images"][0]
