...
classifier.load_state_dict(torch.load("./sa/cifar10_classifier/model/CIFAR10_cifar10_train.pynet.pth", map_location=device, weights_only=True))
classifier.eval()

result_dir = "./cifar10_sd/"
...
weights_path = "./sd/cifar10_sd/cifar10_finetune_lorav1.5-000005.safetensors"
