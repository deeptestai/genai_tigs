...
from cifar10_vae.vae_model import ConvVAE
...
dataset = datasets.ImageFolder(
    root="./cifar10_lora_gen_img", transform=transform
)
...
np.save("output_cifar10_vae_ddpm.npy", all_imgs)
# Save the image info
