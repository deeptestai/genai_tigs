...
classifier.load_state_dict(torch.load("./svhn_classifier/model/SVHN_vggnet.pth", map_location=device))
classifier.eval()
...
batch_size = 6
walk_steps = 60
proj_path = "./evolution_ddpmlatentwalk_svhn/test_"
...
model = DDPMPipeline.from_pretrained("Maryamm/ddpm_finetune_svhn").to(device)
...
for n in range(num_samples):
   ...
   # original_lv = original_lv.unsqueeze(1)
