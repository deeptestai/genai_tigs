...
from experiments.svhn_experiments.model.model import VGGNet
...
dataset = datasets.ImageFolder(
    root="./svhn_lora_gen_img", transform=transform
)
...
np.save("output_svhn_vae_lora.npy", all_imgs)
# Save the image info
