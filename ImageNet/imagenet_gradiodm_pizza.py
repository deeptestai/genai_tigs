...
weights_path = "./sd/imagenet_sd/fine_tune_imgnet-000005.safetensors"
...
predicted_labels = []
all_img_lst = []
def run_diffusion_tig_pizza(gen_num, pop_size, best_left, perturbation_size, initial_perturbation_size,
    ...
    for n in range(imgs_to_samp):
        ...
        yield (
          f"Processing image {n + 1} / {imgs_to_samp}|Misclassified seeds {num_misclassified}|% Misclassification: {misclassification_rate} |Avg Iterations:{Avg_iterations: .2f}",
